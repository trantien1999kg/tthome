<?php  if(!defined('_source')) die("Error");
	$maps = $db->rawQuery("select * from #_map where hienthi=1 order by stt asc, id desc");
    ...
    $str_breadcrumbs =$breadcrumbs->getUrl('Trang chủ',array(array('alias'=>'he-thong-cua-hang','name'=>'Hệ thống cửa hàng')));
