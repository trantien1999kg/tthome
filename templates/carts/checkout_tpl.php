				...
				<div class="item10 col-12 w-100-m mb20 mt20">
					...
					<div class="wrap__paymentstep">
						...
						<div class="row10 d-flex flex-wrap">
							...
							<div class="item10 col-4 <?php if($com=='carts' && $_GET["src"]=='thanh-toan'){echo "bg-step__active";}?> w-100-m">
							...
							<div class="bg-white pd20">
	                            ...
	                            <div class="row-input">
	                                ...
	                                <div class="wrap-input">
	                                    ...
	                                    <select class="input-select select wrap-input__checkout-city" name="id_city" id="id_city"  onchange="onChangePSL('#id_dist',{id:this.value, fs:'id,name_<?=$lang?> as name, code',fw:'id_city',t:'place/dists',tt:'Chọn quận huyện'})">
	                            ...
	                            <div class="row-input">
	                                ...
	                                <div class="wrap-input">
	                                    ...
	                                    <select class="input-select select wrap-input__checkout-dist" name="id_dist" id="id_dist">
