<?php
	...
	$attr_com=array(
		...
		array("tbl"=>"baiviet","field"=>"id","source"=>"news","com"=>"thiet-ke-thi-cong","type"=>"thiet-ke-thi-cong"),

		array("tbl"=>"baiviet_list","field"=>"idl","source"=>"news","com"=>"thiet-ke-thi-cong","type"=>"thiet-ke-thi-cong"),
