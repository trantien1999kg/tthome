            ...
            if(!empty($filephu)){
                ...
                if($id){
                    ...
                    if($filephu['error']==0){
                        ...
                        $photo = $this->_func->uploadImg($id,"photo1","",$filephu,$folder,$this->_com,$table['img-width'],$table['img-height'],$table['img-ratio'],$table['img-b']);
                    ...
                    if($filephu['error']==0){
                        ...
                        $photo = $this->_func->uploadImg(0,"photo1","",$filephu,$folder,$this->_com,$table['img-width'],$table['img-height'],$table['img-ratio'],$table['img-b']);
