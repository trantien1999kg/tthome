...

{
    ...
    //&#8249;
        ...
        if ($previous_btn && $this->cur_page > 1) {
            ...
            $msg .= "<li p='$pre' class='active'><a><i class='fas fa-chevron-left'></i></a></li>";

        } else if ($previous_btn) {

            $msg .= "<li class='$this->class_inactive'><a><i class='fas fa-chevron-left'></i></a></li>";
        ...
        if ($next_btn && $this->cur_page < $no_of_paginations) {
            ...
            $msg .= "<li p='$nex' class='active'><a><i class='fas fa-chevron-right'></i></li>";

        } else if ($next_btn) {

            $msg .= "<li class='$this->class_inactive'><a><i class='fas fa-chevron-right'></i></a></li>";
