...
<div class="wrapper">
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a
                        href="index.html?com=flashsale&act=add<?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"><span>Flash sale</span></a>
                </li>
    ...
    <form name="supplier" class="form"
        action="index.html?com=flashsale&act=save<?php if($_GET['id']!='') echo'&id='. $_GET['id'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colLeft' ?>">
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Không được để trống" name="data[date]" title="Nhập địa chỉ"
                                id="date" class="tipS daterange" value="<?php if($item["date"]!=''){ echo @date("Y-m-d",$item['date']);}else{ echo @date('Y-m-d');}?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Không được để trống" name="time" title="Nhập địa chỉ"
                                id="time" class="tipS timerange" value="<?=@date("H:i",$item['time_start'])?> - <?=@date("H:i",$item['time_end'])?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
                ...
                <div class="box-admin" style="display:flex; align-items:center;justify-content:flex-end">
                    ...
                    <div class="box-action">
                        ...
                        <a class="btn btn-sm bg-gradient-danger text-white"
                            href="index.html?com=flashsale&act=man<?php if($_GET['type']!='') echo'&type='. $_GET['type'];?>">
