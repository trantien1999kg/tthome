    ...
    <div class="control_frm">
        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li>
                    <a
                        href="index.html?com=flashsale&act=man<?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"><span>Flash sale</span></a>
                </li>
            ...
            <div class="box-admin" style="display:flex; align-items:center;">
                ...
                <div class="box-action">
                    ...
                    <a class="btn btn-sm bg-gradient-primary text-white"
                        href="index.html?com=flashsale&act=add<?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>">
                        ...
                        <tr>
                            ...
                            <td class="title_name_data">
                                ...
                                <div class="add-attr mt10">
                                    <a style="color:#37a000;font-size:12px" href="index.php?com=flashsale&act=man_info&tbl=info&id_flash=<?= $items[$i]['id'] ?>&page=1"
                                        class="tipS SC_bold">
                            ...
                            <td class="title_name_data">
                                <?=date("H:i",$items[$i]['time_start'])?> - <?=date("H:i",$items[$i]['time_end'])?>
                            </td>
                            ...
                            <td class="actBtns">
                                ...
                                <a class="text-primary"
                                    href="index.html?com=flashsale&act=edit<?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
