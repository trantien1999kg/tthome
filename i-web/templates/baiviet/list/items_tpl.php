        ...
        $.confirm({
            ...
            buttons: {
                success: {
                    ...
                    btnClass: 'btn-blue',
                    action: function(){
                       redirect("index.html?com=baiviet&act=delete_list&tbl=<?=$_GET['tbl']?>&type=<?=$_GET['type']?>&page=<?=$_GET['page']?>&listid=" + listid);
                    }
                },
                cancel: {   
                    text: 'Hủy ngay!',
...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            <li><a
                    href="index.html?com=baiviet&act=man_list&tbl=<?=$_GET['tbl']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?>"><span>Danh sách</span></a>
            </li>
            <?php if($_GET['keyword']!=''){ ?>
