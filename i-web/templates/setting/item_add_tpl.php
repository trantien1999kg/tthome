        ...
        <div class="widget mtop0">
            ...
            <div class="formRow lang_hidden ">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Chữ Ký không được để trống" type="text"
                        name="data[chuky]" title="Nhập Chữ Ký" id="chuky"
                        class="tipS validate[required]" value="<?=@$item['chuky']?>" />
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Địa chỉ không được để trống"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Email không được để trống" type="text"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Hotline không được để trống"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Website" không được để trống"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Fanpage không được để trống"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Tọa độ không được để trống" type="text"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <textarea data-validation="required" data-validation-error-msg="Iframe không được để trống" rows="8"
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input data-validation="required" data-validation-error-msg="Phân trang không được để trống"
