            ...
            $.confirm({
                ...
                buttons: {
                    success: {
                        ...
                        btnClass: 'btn-blue',
                        action: function(){
                           redirect("index.html?com=contact&act=delete&type=<?=$_GET['type']?>&page=<?=$_GET['page']?>&listid=" + listid);
                        }
                    },
                    cancel: {   
                        text: 'Hủy ngay!',
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        ...
                        <td class="tb_data_small"><a href="#" class="tipS" style="margin: 5px;"><?=_sothutu?></a></td>
                        <td class="sortCol">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actBtns">
                            <a class="text-primary" href="index.html?com=contact&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"
