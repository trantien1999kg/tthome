...
window.MagicZoom = function () {
  ...
  w = y = function () {
    var S = {
      ...
      getStorage: function getStorage(V) {
      ...
      defined: function defined(V) {
        return undefined != V;
      },
      ifndef: function ifndef(W, V) {
        return undefined != W ? W : V;
      },
      exists: function exists(V) {
        return !!V;
      },
      jTypeOf: function jTypeOf(V) {
        if (!M.defined(V)) {
          return false;
        }
      ...
      implement: function implement(Z, Y) {
      ...
      nativize: function nativize(X, W) {
        if (!M.defined(X)) {
          return X;
        }
      ...
      $new: function $new(V, X, W) {
        return M.$(M.doc.createElement(V)).setProps(X || {}).jSetCss(W || {});
      },
      addCSS: function addCSS(W, Y, ac) {
        var Z,
            X,
            aa,
            ab = [],
      ...
      removeCSS: function removeCSS(Y, V) {
        var X, W;
        X = M.$(Y);
      ...
      getHashCode: function getHashCode(X) {
        var Y = 0,
            V = X.length;
    ...
    M.Array = {
      ...
      contains: function contains(V, W) {
        return this.indexOf(V, W) != -1;
      },
      forEach: function forEach(V, Y) {
    ...
    S.implement(Function, {
      ...
      jBindAsEvent: function jBindAsEvent() {
        var W = M.$A(arguments),
            V = this,
            X = W.shift();
        return function (Y) {
    ...
    M.normalizeCSS = T;
    M.Element = {
      jHasClass: function jHasClass(V) {
        return !(V || "").has(" ") && (this.className || "").has(V, " ");
      },
      jAddClass: function jAddClass(Z) {
      ...
      jRemoveClass: function jRemoveClass(aa) {
        var W = (this.className || "").match(U) || [],
            Z = (aa || "").match(U) || [],
            V = Z.length,
            Y = 0,
      ...
      jToggleClass: function jToggleClass(V) {
        return this.jHasClass(V) ? this.jRemoveClass(V) : this.jAddClass(V);
      },
      jGetCss: function jGetCss(W) {
        var X = W.jCamelize(),
            V = null;
        W = O[X] || (O[X] = T(X));
        V = I(this, W);
      ...
      jSetCssProp: function jSetCssProp(W, V) {
        var Y = W.jCamelize();
      ...
      jGetStyles: function jGetStyles() {
        var V = {};
      ...
      jSetOpacity: function jSetOpacity(X, V) {
        var W;
        V = V || false;
      ...
      jGetSize: function jGetSize() {
        return {
          width: this.offsetWidth,
          height: this.offsetHeight
        };
      },
      getInnerSize: function getInnerSize(W) {
        var V = this.jGetSize();
      ...
      jGetScroll: function jGetScroll() {
        return {
          top: this.scrollTop,
          left: this.scrollLeft
        };
      },
      jGetFullScroll: function jGetFullScroll() {
        var V = this,
            W = {
          top: 0,
          left: 0
      ...
      jGetPosition: function jGetPosition() {
        var Z = this,
            W = 0,
            Y = 0;
      ...
      changeContent: function changeContent(W) {
        try {
          this.innerHTML = W;
        } catch (V) {
          this.innerText = W;
    ...
    M.Doc = {
      ...
      jGetFullSize: function jGetFullSize() {
        var V = this.jGetSize();
        return {
    ...
    M.extend([M.Element, M.Doc], {
      ...
      jStore: function jStore(X, W) {
        var V = M.getStorage(this.$J_UUID);
        V[X] = W;
        return this;
      },
      jDel: function jDel(W) {
        var V = M.getStorage(this.$J_UUID);
        delete V[W];
        return this;
      }
    ...
    if (!(window.HTMLElement && window.HTMLElement.prototype && window.HTMLElement.prototype.getElementsByClassName)) {
      M.extend([M.Element, M.Doc], {
        getElementsByClassName: function getElementsByClassName(V) {
    ...
    M.extend([M.Element, M.Doc], {
      byClass: function byClass() {
        return this.getElementsByClassName(arguments[0]);
      },
      byTag: function byTag() {
    ...
    M.Event = {
      ...
      stopDistribution: function stopDistribution() {
      ...
      getClientXY: function getClientXY() {
        var W, V;
      ...
      jGetPageXY: function jGetPageXY() {
        var W, V;
        W = /touch/i.test(this.type) ? this.changedTouches[0] : this;
        return !M.defined(W) ? {
          x: 0,
      ...
      isPrimaryTouch: function isPrimaryTouch() {
    ...
    M.Event.Custom = {
      ...
      isQueueStopped: M.$false,
      events: M.$([]),
      pushToEvents: function pushToEvents(V) {
        var W = V;
        this.events.push(W);
      },
      stop: function stop() {
    ...
    M.extend([M.Element, M.Doc], {
      jAddEvent: function jAddEvent(X, Z, aa, ad) {
        var ac, V, Y, ab, W;
      ...
      jRemoveEvent: function jRemoveEvent(ab) {
      ...
      jCallEvent: function jCallEvent(Z, ab) {
      ...
      jRaiseEvent: function jRaiseEvent(W, V) {
      ...
      jClearEvents: function jClearEvents() {
    ...
    (function (W) {
      ...
      W.Event.Custom.mousedrag.handler = {
        ...
        handleMouseDown: function handleMouseDown(Y) {
          var X;
        ...
        handleMouseUp: function handleMouseUp(Y) {
          var X;
        ...
        handleMouseMove: function handleMouseMove(Y) {
          var X;
          X = this.jFetch("event:mousedrag:dragstart");
    ...
    (function (ab) {
      ...
      ab.Event.Custom.tap.handler = {
        ...
        onClick: function onClick(ac) {
          ac.stopDefaults();
        },
        onTouchStart: function onTouchStart(ac) {
          if (!V(ac)) {
        ...
        onTouchEnd: function onTouchEnd(af) {
          var ad = ab.now(),
    ...
    (function (aa) {
      ...
      aa.Event.Custom.touchdrag.handler = {
        ...
        onTouchEnd: function onTouchEnd(ac) {
          var ab;
        ...
        onTouchMove: function onTouchMove(ac) {
          var ab;
          ab = this.jFetch("event:touchdrag:dragstart");
    ...
    M.Event.Custom.touchpinch.handler = {
      ...
      handleTouchStart: function handleTouchStart(W) {
        var V;
      ...
      handleTouchEnd: function handleTouchEnd(W) {
        var V;
      ...
      handleTouchMove: function handleTouchMove(W) {
        var V;
        V = this.jFetch("event:touchpinch:event");
    ...
    (function (aa) {
      ...
      aa.Event.Custom.mousescroll = new aa.Class(aa.extend(aa.Event.Custom, {
        type: "mousescroll",
        init: function init(ag, af, ai, ac, ab, ah, ad) {
  ...
  (function (H) {
    ...
    H.FX = new H.Class({
      ...
      parseCubicBezier: function parseCubicBezier(I) {
        var J,
            K = null;
      ...
      cubicBezierAtTime: function cubicBezierAtTime(U) {
        var I = 0,
            T = 0,
            Q = 0,
            V = 0,
    ...
    H.FX.Transition = {
      ...
      backIn: "easeInBack",
      backOut: "easeOutBack",
      elasticIn: function elasticIn(J, I) {
        I = I || [];
        return Math.pow(2, 10 * --J) * Math.cos(20 * J * Math.PI * (I[0] || 1) / 3);
      },
      elasticOut: function elasticOut(J, I) {
      ...
      bounceOut: function bounceOut(I) {
  ...
  (function (I) {
    ...
    w.ImageLoader = new I.Class({
      ...
      loadedBytes: 0,
      _handlers: {
        onprogress: function onprogress(J) {
          if (J.target && (200 === J.target.status || 304 === J.target.status) && J.lengthComputable) {
            this.options.onprogress.jBind(null, (J.loaded - (this.options.progressiveLoad ? this.loadedBytes : 0)) / J.total).jDelay(1);
            this.loadedBytes = J.loaded;
          }
        },
        onload: function onload(J) {
          if (J) {
            H(J).stop();
          }
  ...
  (function (H) {
    ...
    var K = H.$,
      ...
      string: 100
        ...
        I = {
      "boolean": function boolean(R, Q, P) {
      ...
      number: function number(S, R, Q) {
        var P = false,
            U = /%$/,
            T = H.jTypeOf(R) == "string" && U.test(R);

        if (Q && !"number" == _typeof(R)) {
          return false;
        }
      ...
      "function": function _function(R, Q, P) {
    ...
    H.extend(L.prototype, {
      parseSchema: function parseSchema(R) {
        var Q, P, S;
      ...
      fromString: function fromString(P) {
      ...
      isset: function isset(P) {
        P = (P + "").jTrim().jCamelize();
        return this.exists(P) && H.defined(this.options[P]);
      },
      jRemove: function jRemove(P) {
        P = (P + "").jTrim().jCamelize();
  ...
  var r = function (I) {
    ...
    G.prototype = {
      ...
      selectItem: function selectItem(K) {
      ...
      setOrientation: function setOrientation(J) {
  ...
  k.prototype = {
    parseNode: function parseNode(I, H, G) {
      var J = I.byTag("img")[0];
    ...
    setCurNode: function setCurNode(G) {
      this.node = this.getNode(G);
    }
  };

  var j = function j(H, G) {
  ...
  j.prototype = {
    loadOptions: function loadOptions(G) {
    ...
    start: function start(H) {
      ...
      this.zoomBox.image.removeAttribute("height"); // if ("undefined" !== typeof(q)) {
    ...
    setupZoom: function setupZoom(I, J) {
    ...
    setupSelectors: function setupSelectors() {
      var H = this.id,
          G,
          I;
    ...
    update: function update(G, H) {
      ...
      G.load(h(function (O) {
        var I,
            ...
            J,
            M,
            L = y.jBrowser.ieMode < 10 ? "jGetSize" : "getBoundingClientRect";
        this.hideLoading();
        O.setCurNode("small");
    ...
    setActiveThumb: function setActiveThumb(H) {
      var G = false;
    ...
    setCaption: function setCaption(G) {
    ...
    showHint: function showHint(G, I) {
      var H;
    ...
    reflowZoom: function reflowZoom(K) {
      var N,
          M,
          G,
          L,
    ...
    changeZoomLevel: function changeZoomLevel(M) {
      var I,
          G,
          K,
          J,
    ...
    registerActivateEvent: function registerActivateEvent(I) {
      var H,
    ...
    unregisterActivateEvent: function unregisterActivateEvent(H) {
    ...
    registerDeactivateEvent: function registerDeactivateEvent(H) {
    ...
    unregisterDeactivateEvent: function unregisterDeactivateEvent() {
    ...
    deactivate: function deactivate(I, N) {
      var L,
          J,
          G,
          H,
    ...
    animate: function animate(Q, P, O) {
      var I = P,
          K,
          J,
          M = 0,
    ...
    setupExpandGallery: function setupExpandGallery() {
      var H, G;
    ...
    destroyExpandGallery: function destroyExpandGallery() {
      var G;
    ...
    expandToWindow: function expandToWindow() {
      this.node.jSetCss({
        transition: ""
      });
      this.node.jSetCss({
    ...
    imageByURL: function imageByURL(H, I) {
    ...
    imageByOrigin: function imageByOrigin(H) {
      var G = this.additionalImages.filter(function (I) {
        return I.origin === H;
      }) || [];
      return G[0];
    },
    imageByIndex: function imageByIndex(G) {
      return this.additionalImages[G];
    }
  };
  t = {
    version: "v5.0.2",
    start: function start(J, H) {
      var I = null,
          G = [];
    ...
    refresh: function refresh(G) {
      this.stop(G);
      return this.start(G);
    },
    update: function update(L, K, J, H) {
      var I = i(L),
          G;
    ...
    switchTo: function switchTo(J, I) {
      var H = i(J),
          G;
    ...
    zoomIn: function zoomIn(H) {
      var G;
      (G = i(H)) && G.activate();
    },
    zoomOut: function zoomOut(H) {
      var G;
      (G = i(H)) && G.deactivate();
    },
    expand: function expand(H) {
      var G;
      (G = i(H)) && G.expand();
    },
    close: function close(H) {
      var G;
      (G = i(H)) && G.close();
    },
    registerCallback: function registerCallback(G, H) {
      if (!p[G]) {
        p[G] = [];
      }
