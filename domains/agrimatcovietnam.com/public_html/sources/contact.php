	...
	if(!empty($_POST)){
		if($_POST['captcha']){
			if($_POST['captcha'] == $_SESSION['captcha_code']){
				...
				if($func->sendMailIndex($row_setting['email'],_lien_he_den_tu.' website',$data['content'],array($row_setting['email'],$data['email']),null,null)){
				...
				$func->transfer('Mã bảo mật không đúng!', $https_config.'lien-he');
			}
	    }else{
			$func->transfer('Bạn vui lòng nhập mã bảo mật!', $https_config.'lien-he');
		}
