FRAMEWORK={
    ...
    rangeChange:function(){
        $("input[data-range]").on("change", function(){
            var $this = $(this);
            var value = $this.val();
	...
	changeAlias:function(){
        ...
        $('.title_seo').keyup(function(){
            ...
            if(_this==''){
                ...
                $('#title_seo_'+_lang).text('[SEO Onpage] là gì? Hướng dẫn tối ưu SEO Onpage...');

            }else{

                $('#title_seo_'+_lang).text(_this);
        ...
        $('.description_seo').keyup(function(){
            ...
            if(_this==''){
                ...
                $('#description_seo_'+_lang).text('Hướng dẫn SEO onpage căn bản tối ưu để trang web chuẩn SEO lên top Google nhanh và bền vững, kỹ thuật tối ưu SEO onpage đơn giản');

            }else{

                $('#description_seo_'+_lang).text(_this);
