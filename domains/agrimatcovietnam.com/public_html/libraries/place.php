...
class place{
    ...
    function getFieldWhere($table,$id,$field_show,$fieldwhere,$order='stt asc, id desc'){
        $result = $this->d->rawQuery("select $field_show from #_$table where hienthi=1 and $fieldwhere=$id order by $order");
        return $result;
    }
}