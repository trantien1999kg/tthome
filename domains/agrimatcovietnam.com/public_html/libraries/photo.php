                ...
                foreach($config['lang'] as $k => $v){
                    ...
                    if(!empty($file)){
                        ...
                        if($file['error']==0){
                            ...
                            $photo = $this->_func->uploadImg(0,"photo_".$k,"thumb_".$k,$file,_upload_temp,$this->_table,$table['img-width'],$table['img-height'],$table['img-ratio'],$table['img-b']);
            ...
            foreach($config['lang'] as $k => $v){
                ...
                if(!empty($file)){
                    ...
                    if($file['error']==0){
                        ...
                        $photo = $this->_func->uploadImg(0,"photo_".$k,"thumb_".$k,$file,$folder,$this->_table,$table['img-width'],$table['img-height'],$table['img-ratio'],$table['img-b']);
