...
<div class="dongu-dongupijama">
    <div class="row5 d-flex flex-wrap">
        ...
        <div class=" col-20 item5">
            <div class="dongu-dongupijama-sp">
            
                <div class="hoverimg">
                <a href="<?= $value['type']?>/<?= $c1['tenkhongdau']?>/<?=$value['tenkhongdau']?>" style="color: white;">
                    <img src="<?= _thumbs?>/440x462x1/<?= _upload_baiviet_l.$value['photo']?>" alt="">
                    <img src="<?= _thumbs?>/440x462x1/<?= _upload_baiviet_l.$value['photo1']?>" alt="">
                    
                    <button>  XEM TẤT CẢ</button>
                    </a>
                </div>
                <h1><?= $value['ten_'.$lang]?></h1><span class="borderbottom"></span>
                <p><?= $value['giaban']?> VND</p>
            </div>
        </div>
        <?php } ?>
    </div>
