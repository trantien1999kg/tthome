...

{
...

    {
        ...
        if ($previous_btn && $this->cur_page > 1) {
            ...
            $msg .= "<li p='$pre' class='active'><a><i class='fa fa-angle-left' aria-hidden='true'></i></a></li>";

        } else if ($previous_btn) {

            $msg .= "<li class='$this->class_inactive'><a><i class='fa fa-angle-left' aria-hidden='true'></i></a></li>";
        ...
        if ($next_btn && $this->cur_page < $no_of_paginations) {
            ...
            $msg .= "<li p='$nex' class='active'><a><i class='fa fa-angle-right' aria-hidden='true'></i></a>    </li>";

        } else if ($next_btn) {

            $msg .= "<li class='$this->class_inactive'><a><i class='fa fa-angle-right' aria-hidden='true'></i></a></li>";
